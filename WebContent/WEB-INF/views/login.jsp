						...
						<div class="form">
							...
							<form class="form-horizontal" action="j_spring_security_check"
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="text" style="width:200px;" class="form-control" name="j_username">
									</div>
								</div>
								<!-- Password -->
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="password" style="width:200px;" class="form-control" name="j_password">
									</div>
								</div>
								<!-- Buttons -->
								<div class="form-group">
