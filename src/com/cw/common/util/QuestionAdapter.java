...
import com.cw.common.domain.question.Question;
import com.cw.common.domain.question.QuestionContent;
import com.cw.common.domain.question.QuestionQueryResult;
import com.cw.common.util.xml.Object2Xml;
...
public class QuestionAdapter {
	 ...
	 *            试题描述
	 */
	public QuestionAdapter(Question question, AnswerSheetItem answerSheetItem, QuestionQueryResult questionQueryResult,
			String baseUrl) {
	...
	public QuestionAdapter(AnswerSheetItem answerSheetItem, QuestionQueryResult questionQueryResult, String baseUrl) {
		this.answerSheetItem = answerSheetItem;
		this.questionQueryResult = questionQueryResult;
		Gson gson = new Gson();
		this.questionContent = gson.fromJson(question.getContent(), QuestionContent.class);
	...
	public QuestionAdapter(QuestionQueryResult questionQueryResult, String baseUrl) {
		this.questionQueryResult = questionQueryResult;
		Gson gson = new Gson();
	...
	public String getStringFromXML() {
		...
		case 1:
			...
			sb.append("<span class=\"knowledge-point-id\" style=\"display: none;\">")
					.append(questionQueryResult.getKnowledgePointId()).append("</span>");
			sb.append("<span class=\"question-type-id\" style=\"display: none;\">")
					.append(questionQueryResult.getQuestionTypeId()).append("</span>");
			sb.append("<span>[单选题]</span>");
			sb.append("<span class=\"question-point-content\">");
			sb.append("<span>(</span><span class=\"question-point\">")
					.append(pointStrFormat(questionQueryResult.getQuestionPoint())).append("</span><span>分)</span>");
			sb.append("</span>");
			...
			sb.append("<p class=\"question-body-text\">").append(StringUtil.trope(questionContent.getTitle()));
			if (questionContent.getTitleImg() != null)
				if (!questionContent.getTitleImg().trim().equals(""))
					sb.append("<img class=\"question-content-img question-img\" src=\"").append(baseUrl)
							.append(questionContent.getTitleImg()).append("\" />");
			sb.append("</p>");
			...
			while (it1.hasNext()) {
				...
				String key = it1.next();
				String value = StringUtil.trope(questionContent.getChoiceList().get(key));
				sb.append("<input type=\"radio\" value=\"").append(key)
				...
				if (questionContent.getChoiceImgList() != null)
					if (questionContent.getChoiceImgList().containsKey(key))
						sb.append("<img class=\"question-opt-img question-img\" src=\"").append(baseUrl)
								.append(questionContent.getChoiceImgList().get(key)).append("\" />");
				sb.append("</span>");
				sb.append("</li>");
			}
			sb.append("</ul>");
		...
		case 2:
			...
			// class=\"question-point\">").append(pointStrFormat(questionQueryResult.getQuestionPoint())).append("</span><span>分)</span>");
			sb.append("<span class=\"question-id\" style=\"display:none;\">")
					.append(questionQueryResult.getQuestionId()).append("</span>");
			sb.append("</div>");
			sb.append("<form class=\"question-body\">");
			...
			if (questionContent.getTitleImg() != null)
				if (!questionContent.getTitleImg().trim().equals(""))
					sb.append("<img class=\"question-content-img question-img\" src=\"").append(baseUrl)
							.append(questionContent.getTitleImg()).append("\" />");
			sb.append("</p>");
			Iterator<String> it2 = questionContent.getChoiceList().keySet().iterator();
			sb.append("<ul class=\"question-opt-list\">");
			while (it2.hasNext()) {
				sb.append("<li class=\"question-list-item\">");
				String key = it2.next();
				String value = StringUtil.trope(questionContent.getChoiceList().get(key));
				sb.append("<input type=\"checkbox\" value=\"").append(key)
						.append("\" name=\"question-radio1\" class=\"question-input\">");
				sb.append("<span class=\"question-li-text\">");
				sb.append(key).append(": ").append(value);
				if (questionContent.getChoiceImgList() != null)
		...
		case 3:
			...
			sb.append("<li class=\"question-list-item\">")
					.append("<input type=\"radio\" value=\"T\" name=\"question-radio2\" class=\"question-input\">")
		...
		case 7:
			...
			sb.append("</div>");
			sb.append("<form class=\"question-body\">");
			sb.append("<p>").append(StringUtil.trope(questionContent.getTitle()));
			if (questionContent.getTitleImg() != null)
				if (!questionContent.getTitleImg().trim().equals(""))
					sb.append("<img class=\"question-content-img question-img\" src=\"").append(baseUrl)
							.append(questionContent.getTitleImg()).append("\" />");
		...
		if (questionQueryResult.getQuestionTypeId() == 3) {
			...
			sb.append("<span class=\"answer_value\">").append(questionQueryResult.getAnswer()).append("</span><br>");
		sb.append("</div>");
		...
		sb.append("<p>");
		sb.append(StringUtil.trope(questionQueryResult.getReferenceName()));
		sb.append("</p></div></div>");
		sb.append("<div class=\"answer-desc-detail\">");
		...
		sb.append("<div class=\"answer-desc-content\">");
		sb.append("<p>");
		sb.append(StringUtil.trope(questionQueryResult.getAnalysis()));
		sb.append("</p></div></div>");
		sb.append("<div class=\"answer-desc-detail\">");
	...
	public String getReportStringFromXML() {
		...
		if (answerSheetItem.getQuestionTypeId() == 3) {
			if (answerSheetItem.getAnswer().trim().equals("T"))
				...
				sb.append("<span>").append(answerSheetItem.getAnswer()).append("</span>");
		} else
			sb.append("<span>").append(answerSheetItem.getAnswer()).append("</span>");
		sb.append("</div>");
		sb.append("<div class=\"answer-desc-detail\">");
	 ...
	 * @return
	 */
	public String getStringFromXML(boolean showAnswer, boolean showPoint, boolean showAnalysis) {
		StringBuilder sb = new StringBuilder();
		...
		case 1:
			...
			if (showPoint) {
				sb.append("<span class=\"question-point-content\">");
				sb.append("<span>(</span><span class=\"question-point\">")
						.append(pointStrFormat(questionQueryResult.getQuestionPoint()))
						.append("</span><span>分)</span>");
				sb.append("</span>");
			}
