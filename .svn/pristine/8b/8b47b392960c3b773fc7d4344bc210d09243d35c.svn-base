...
public class ExamPaper implements Serializable {
	...
	protected int id; // 考试试卷编号
	protected String name; // 考试试卷名称
	protected String content; // 试卷内容
	protected int duration; // 持续时长
	protected int pass_point; // 及格分数
	protected float total_point; // 总分数
	...
	protected boolean is_visible; // 是否可见
	protected int group_id; // 小组编号
	protected boolean is_subjective; // 是否为个人的
	protected String answer_sheet;// 试题答案
	protected String creator; //创建者
	protected String paper_type;// 试卷类型
	protected int field_id; // 题库编号
	protected int field_name; //题库名称
	...
	public String toString() {
		return "ExamPaper [id=" + id + ", name=" + name + ", content=" + content + ", duration=" + duration
				...
				+ ", status=" + status + ", subjective=" + is_subjective + ", summary=" + summary + ", is_visible="
				+ is_visible + ", group_id=" + group_id + "]";
	}
