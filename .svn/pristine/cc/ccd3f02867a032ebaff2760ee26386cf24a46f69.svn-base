		...
		<div class="container">
			<nav class="collapse navbar-collapse bs-navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="student/setting"><i
							class="fa fa-cogs"></i>个人设置</a></li>
				</ul>
			</nav>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-xs-2">
					<ul class="nav default-sidenav">
						<li><a href="student/setting"> <i class="fa fa-cogs"></i>
								基本资料
						</a></li>
						<li class="active"><a> <i class="fa fa-wrench"></i> 修改密码
						</a></li>
				...
				<div class="col-xs-10">
					...
					<div class="page-content row">
						<form class="form-horizontal" id="form-change-password"
							action="student/change-pwd" style="margin-top: 40px;"
							method="post">
