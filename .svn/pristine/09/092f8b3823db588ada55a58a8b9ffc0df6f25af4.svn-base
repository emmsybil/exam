...
import com.cw.common.domain.question.QuestionType;
...
public class PracticePage {
	...
	public String practiceImprove(Model model, HttpServletRequest request, @PathVariable("fieldId") int fieldId,
		...
		// + "/manager-exam/uploadFile/";
		List<QuestionQueryResult> qqrList = questionService.getQuestionAnalysisListByPointIdAndTypeId(questionTypeId,
				knowledgePointId);
		...
		return "practice/practice-improve-qh";
	}
	...
	public String practiceIncorrectQuestions(Model model, HttpServletRequest request,
		...
		return "practice/practice-improve";
	}
	...
	public String practiceStartNew(Model model, HttpServletRequest request, @PathVariable("fieldId") int fieldId) {
		...
		return "training/practice-improve";
	}
