...
import com.cw.portal.persistence.QuestionHistoryMapper;
...
public class QuestionHistoryServiceImpl implements QuestionHistoryService {
	...
	public int queryDurationById(int id) {
		// TODO Auto-generated method stub
		return questionHistoryMapper.queryDurationById(id);
	}
	...
	public void updateExamHistory(ExamHistory examHistory){
		questionHistoryMapper.updateExamHistory(examHistory);
	}
	
	@Override
	public Map<Integer, Map<Integer, QuestionStatistic>> getTypeQuestionHistStaticByFieldId(int fieldId, int userId) {
		// TODO Auto-generated method stub
		List<QuestionStatistic> statisticList = questionHistoryMapper.getTypeQuestionHistStaticByFieldId(fieldId,
				userId);
