...
<body>
	...
	<div class="autoHeight">
		...
		<div class="video-div" style="background-color: #000; height: 100%;">
			...
			<input type="hidden" value="${sectionId}" id="section-id"> <input
				type="hidden" value="${section.trainingId}" id="training-id">
			...
			<video id="my_video" class="video-js vjs-default-skin" controls
				...
				style="width: 100%; height: 100%;" poster="resources/images/bg.png"
				data-setup="{}">
				<c:choose>
		...
		<div class="tab-content">
			...
			<div role="tabpanel" class="tab-pane" id="profile">
				...
				<div id="show-more-div">
					<input type="hidden" id="idx-hidden" value="2"> <input
						type="hidden" id="last-floor-hidden" value="0">
					<button id="show-more-btn" disabled="disabled"
						style="margin: 10px 0 10px 0;">没有更多评论了...</button>
				</div>
			</div>
		</div>
	</div>
