		...
		<div class="container">
			<nav class="collapse navbar-collapse bs-navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="student/practice-list"><i
			...
			<ul class="nav nav-pills " style="margin: 20px 0;">
				<c:forEach items="${fieldList }" var="item">
					<li role="presentation"
						<c:if test="${item.fieldId == fieldId }"> class="active"</c:if>><a
			...
			<div class="row">
					...
					<div class="question-list">
						...
						<c:forEach items="${kparl}" var="item">
							...
							<table class="table-striped table">
								<thead>
									<tr>
										<td colspan="4"><h6>${item.knowledgePointName }</h6> <span
								...
								<tbody>
									<c:forEach items="${item.typeAnalysis }" var="tp">
										<tr>
											...
											<td><a
												href="student/practice-improve/${fieldId }/${item.knowledgePointId }/${tp.questionTypeId }"
				...
				<div class="col-xs-6">
							...
							<tbody>
								<c:forEach items="${historyMap }" var="item">
									<tr>
										...
										<td><a
											href="student/practice-incorrect/${item.value.fieldId }/${item.value.pointId }"
											class="btn btn-success btn-sm join-practice-btn">参加练习</a></td>
									</tr>
								</c:forEach>
					...
					<a class="btn btn-success "
						href="student/practice-test/${fieldId }">随机来20道 </i>
					</a>
				</div>
